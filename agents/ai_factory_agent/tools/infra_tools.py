...
IMPORTANT: Red Hat personas do NOT have direct programmatic access to
customer environments. Infrastructure data is provided by the customer
in an acceptable format (YAML) and stored locally. Customer-facing agents
may in the future integrate with live APIs within the customer's own
